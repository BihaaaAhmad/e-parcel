...
<html>
    ...
    <body>
        <div class="bg-img">
            <form action="doLoginAdmin.jsp" class="container" >
                <!--<button class="btn" value="Back" onclick="history.back()"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>-->
                ...
                <input type="text" placeholder="Enter Manager ID" name="adminid" required><br>
